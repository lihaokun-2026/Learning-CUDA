...
def solar_system():
    # Normalized Sun + four planets. Initial velocities are tangential.
    particles = [(0, 0, 0, 0, 0, 0, 1000.0)]
    planets = [(0.4, 0.01), (0.7, 0.02), (1.0, 0.03), (1.5, 0.04)]
    for radius, mass in planets:
        particles.append((radius, 0, 0, 0, math.sqrt(1000.0 / radius), 0, mass))
    return particles
...
print("Generated two_body, solar_system, cluster_64, disk_1024 cases in", ROOT)
